...
# This environment contains production infrastructure resources
...
module "monitoring_alerting" {
  ...
  # Thresholds (production has tighter thresholds)
...
module "cost_optimization" {
  ...
  # Reserved Instance recommendations (enabled for production)
...
module "compliance_monitoring" {
  ...
  # Compliance configuration (all features enabled for production)
  ...
  # Schedule for compliance checks (more frequent for production)
  compliance_check_schedule = var.compliance_check_schedule

  # Compliance standards (all enabled for production)
