...
output "cross_region_backup_bucket_name" {
  ...
  value       = module.database_backup.cross_region_backup_bucket_name
}
...
output "service_budget_names" {
  ...
  value       = module.cost_optimization.service_budget_names
}
...
output "security_hub_standards" {
  ...
  value       = module.compliance_monitoring.security_hub_standards
}

# URLs and Links
output "aws_console_links" {
  description = "Useful AWS console links for production environment"
  value = {
